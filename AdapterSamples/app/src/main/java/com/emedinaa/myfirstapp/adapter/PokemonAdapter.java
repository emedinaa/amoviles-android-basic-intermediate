...
public class PokemonAdapter  extends RecyclerView.Adapter<PokemonAdapter.ViewHolder>{
    ...
    public PokemonAdapter(Context context, List<Pokemon> pokemons) {
        ...
        this.pokemonListener= (PokemonListener) context;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.iviPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.v("CONSOLE", "Adapter Click photo "+pokemonName);
                /*if(myInterface!=null){
                    myInterface.showItemMessage(itemPosition,pokemonName);
                }*/
                /*PokemonListActivity pokemonListActivity= (PokemonListActivity)context;
                if(pokemonListActivity!=null){
                    pokemonListActivity.itemClickPhoto(pokemon);
                }*/
                if(pokemonListener!=null){
                    pokemonListener.clickItemPokemon(pokemon);
                }
            }
        });
